...
nerd = system("sudo git clone https://github.com/scrooloose/nerdtree.git ~/.vim/bundle/nerdtree.vim")
...
vimrc_master = `curl https://raw.github.com/gkchestertron/omniloader/master/master_settings/.vimrc`
Dir.chdir
...
bashrc_master = `curl https://raw.github.com/gkchestertron/omniloader/master/master_settings/.bashrc`
Dir.chdir
